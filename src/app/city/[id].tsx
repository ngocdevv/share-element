...
export default function CityDetailScreen() {
    ...
    const { id, name, location, rating, image } = useLocalSearchParams();
        ...
        <View style={styles.container}>
            ...
            <View style={styles.imageContainer}>
                ...
                <View style={styles.floatingImagesContainer}>
                    <BlurView intensity={30} tint="dark" style={styles.miniImageWrapper}>
                        <Image source={{ uri: image as string }} style={styles.miniImage} />
                    </BlurView>
                    <BlurView intensity={30} tint="dark" style={styles.miniImageWrapper}>
                        <Image source={{ uri: image as string }} style={styles.miniImage} />
                    </BlurView>
...
const styles = StyleSheet.create({
    ...
    floatingImagesContainer: {
        position: 'absolute',
        bottom: 40, // Height of the curve overlap
        left: 0,
        right: 0,
        flexDirection: 'row',
        justifyContent: 'center',
