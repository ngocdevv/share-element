                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.cardsScroll} snapToInterval={width * 0.7 + 20} decelerationRate="fast">
                    {CITIES.map((city) => (
                        <Link
                            ...
                            href={{
                                pathname: "/city/[id]",
                                params: { id: city.id, name: city.name, location: city.location, rating: city.rating, image: RNImage.resolveAssetSource(city.image).uri }
                            }}
                            asChild
                        >
                            <Pressable style={styles.card}>
                                ...
                                <BlurView intensity={20} tint="light" style={styles.cardOverlay}>
...
const styles = StyleSheet.create({
    ...
    card: {
        ...
        elevation: 8,
        position: 'relative',
        overflow: 'visible', // Important for shadow
    },
    cardImage: {
        width: '100%',
        height: '100%',
